...
export const globalStyles = StyleSheet.create({
  ...
  // ==========================================
  // 25. NOTIFICATION PUSH MANAGEMENT
  // ==========================================
  ...
  notificationPromoBadge: {
    backgroundColor: colors.notification.promo,
    paddingHorizontal: 8,
    paddingVertical: 2,
    borderRadius: 12,
    alignSelf: "flex-start",
  ...
  notificationTargetTextSelected: {
    fontWeight: "bold",
  },
